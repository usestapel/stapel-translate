# Contributing to stapel-translate
...
```bash
git clone https://github.com/usestapel/stapel-translate.git && cd stapel-translate
...
The packages use a flat layout (`package-dir = {{"stapel_translate": "."}}`), so the
